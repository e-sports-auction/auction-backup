                ...
                <div class="container-fluid">
                  ...
                  <div class="d-flex" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active text-light" aria-current="page" href="viewTrophyForPlayerStatus.aspx">Back</a>
                      </li>
                      <li class="nav-item">
            ...
            <table class="table players">
                ...
                <tbody>
                    <asp:DataList ID="dl_auctionList" runat="server">
                        <ItemTemplate>
                          <tr>
                            <td style="padding-left:90px" class="td-img">
                                <div>
                                    <asp:Image ID="Image1" class="profile-pic" runat="server" ImageUrl='<%#Eval("Image") %>' />
                                </div>
                            </td>
                            <td style="padding-left:90px" class="td-name"><%#Eval("FirstName") %> <%#Eval("LastName") %></td>
                            <td style="padding-left:90px" class="td-status">
                                <span class="badge badge-warning"><%#Eval("AuctionStatus") %></span>
                            </td>
                            <td style="padding-left:170px" class="td-team"><%#Eval("Team") %></td>
                            <td style="padding-left:190px" class="td-price"><%#Eval("SoldPrice") %> LKR</td>
                          </tr>
