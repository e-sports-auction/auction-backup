<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="playersReport.aspx.cs" Inherits="eSport.reports.playersReport" %>
            ...
            <table class="table players">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th style="padding-left:50px" scope="col">Role</th>
                    <th scope="col">Matches</th>
                    <th scope="col">Arm Style</th>
                  </tr>
                </thead>
                <tbody>
                    <asp:DataList ID="dl_auctionList" runat="server">
                        <ItemTemplate>
                          <tr>
                            ...
                            <td style="padding-left:20px" class="td-status"><%#Eval("Email") %></td>
                            <td style="padding-left:20px" class="td-status"><%#Eval("Role") %></td>
                            <td style="padding-left:60px" class="td-team"><%#Eval("Matches") %></td>
                            <td style="padding-left:170px" class="td-price"><%#Eval("ArmStyle") %></td>
                          </tr>
