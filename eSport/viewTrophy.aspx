<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewTrophy.aspx.cs" Inherits="eSport.viewTrophy" %>
            ...
            <div class="container-fluid">
              ...
              <div class="d-flex" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active text-light" aria-current="page" href="player-dashboard.aspx">Home</a>
                  </li>
                    <li class="nav-item">
                    ...
                    <div class="">
                        <div class="row text-center">
                            <div class="col">
                                ...
                                <asp:Button ID="btn_applyTrophy"  CssClass="btn"  CommandArgument='<%#Eval("TrophyID") %>' OnClick="btn_applyTrophy_Click" runat="server"  Text="Apply" />
                            </div>
                        </div>
                    </div>
                </a>
